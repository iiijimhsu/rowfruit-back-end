...
$resultstorage1 = $conn->query($sqlstorage);
$resultstorage2 = $conn->query($sqlstorage);
$resultstorage3 = $conn->query($sqlstorage);
...
$aa = "SELECT * FROM customize_order";
$bb = "SELECT * FROM customized_order_detail";
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <button type="submit" class="btn btn-info mx-3" data-toggle="modal" data-target="#add">新增訂單</button>
                            <!-- Modal -->
                            <div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">新增客製化訂單資料</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="Customized-order-insert-data.php" method="post">
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-3 col-form-label"><span class="text-danger">* </span>訂單編號:PO</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-3 col-form-label"><span class="text-danger">* </span>會員編號:RF</label>
                                                    <div class="col-sm-9">
                                                        <input type="memberid" class="form-control" name="member_list_id" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-3 col-form-label"><span class="text-danger">* </span>商品編號ST</label>
                                                    <div class="col-sm-9">
                                                        <!-- <input type="memberid" class="form-control" name="storage_id[]" required>      -->
                                                        <select class="form-control form-control-lg" name="storage_id[]" > 
                                                            <option>商品編號</option>
                                                            <?php while($rowstorage = $resultstorage1->fetch_assoc()){?>
                                                                <option><?=  $rowstorage["id"] ?><?=  $rowstorage["fruitname"] ?></option>
                                                ...
                                                <!-- <div class="form-group row">
                                                    <label for="" class="col-sm-3 col-form-label"><span class="text-danger">* </span>供應商編號:WF</label>
                                                    <div class="col-sm-9">
                                                        <input type="hidden" class="form-control" name="farmer_list_id[]" READONLY>
                                                    </div>
                                                </div> -->
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-3 col-form-label"><span class="text-danger">* </span>訂單日期</label>
                                                    <div class="col-sm-9">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <div class="col-sm-9">
                                                <input type="text" class="form-control-plaintext" name="productname" value=" <?= $row["id"] ?>"READONLY>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            <label for="" class="col-sm-5 col-form-label"><span class="text-danger"> </span>會員姓名</label>
                                            <div class="col-sm-9">
                                            <input type="text" class="form-control-plaintext" name="memberid" value="<?= $memberlist[$row["member_list_id"]] ?>"READONLY>
                                            ...
                                            <label for="" class="col-sm-5 col-form-label"><span class="text-danger"> </span>商品</label>
                                                <div class="col-sm-9 ">
                                                <input type="text" class="form-control-plaintext" name="item" value="<?= $storagefu[$oddetailst[$row["id"]]] ?>"READONLY>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="" class="col-sm-5 col-form-label"><span class="text-danger"> </span>數量</label>
                                                <div class="col-sm-9">
                                                <input type="number" class="form-control-plaintext" name="quantity" value="<?= $oddetailqu[$row["id"]] ?>"READONLY>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="" class="col-sm-5 col-form-label"><span class="text-danger"></span>金額</label>
                                                <div class="col-sm-9">
                                                <input type="text" class="form-control-plaintext" name="content" value="<?= $storagepr[$oddetailst[$row["id"]]]*$oddetailqu[$row["id"]] ?>"READONLY>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="" class="col-sm-5 col-form-label"><span class="text-danger"> </span>供應商姓名</label>
                                                <div class="col-sm-9">
                                                <input type="text" class="form-control-plaintext" name="productname" value="<?=$farmerlist[$storagefa[$oddetailst[$row["id"]]]] ?>"READONLY>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="Customized-order-edit-data.php" method="post">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-9">
                                                                                        <input type="datetime-local" class="form-control" name="now" value="<?= $row["date"] ?>" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
